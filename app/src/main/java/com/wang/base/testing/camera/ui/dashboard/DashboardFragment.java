package com.wang.base.testing.camera.ui.dashboard;
...
//            Toast.makeText(getActivity(), "Camera2 API not supported on this device", Toast.LENGTH_LONG).show();
//        }
//    }
//
...
//                Toast.makeText(getActivity(), "ERROR: Camera permissions not granted", Toast.LENGTH_LONG).show();
//            }
//        } else {
